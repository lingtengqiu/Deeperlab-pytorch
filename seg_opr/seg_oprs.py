...
# For DFN
#according to dfn, this have two part input , High stage and low_stage ,hight stage concate low staget ,
#using some Residual block to get the mul_vector ,to deal with diverse in different stage
#CAB
